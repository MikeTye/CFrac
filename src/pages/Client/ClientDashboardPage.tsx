            ...
            <div className="dash-empty-inner">
                ...
                <div className="dash-empty-copy">
                    ...
                    <div className="stack-row" style={{ marginTop: '1.5rem', gap: '0.65rem' }}>
                        <Link className="btn" to="/client/advisors">Search advisors</Link>
...
function AdvisorDiscoveryStrip() {
    return (
        <section className="dash-discovery-strip">
            <div className="dash-discovery-copy">
                <p className="hero-eyebrow">Advisor discovery</p>

                <h2 className="dash-discovery-title">
                    Search by challenge, not just job title.
                </h2>

                <p className="muted">
                    Describe the business problem you are trying to solve and discover
                    operators with directly relevant experience.
                </p>
            </div>

            <div className="dash-discovery-search">
                <input
                    type="text"
                    placeholder="Example: Need help preparing for Series A fundraising"
                />

                <Link to="/client/advisors" className="btn">
                    Search advisors
                </Link>
            </div>

            <div className="dash-discovery-tags">
                <Link to="/client/advisors?topic=fundraising">Fundraising</Link>
                <Link to="/client/advisors?topic=go-to-market">Go-to-market</Link>
                <Link to="/client/advisors?topic=regional-expansion">Regional expansion</Link>
                <Link to="/client/advisors?topic=hiring">Leadership hiring</Link>
            </div>
        </section>
    );
}
    ...
    return (
        <aside className="dash-panel card">
            ...
            <div className="dash-panel-section dash-panel-cta premium">
                ...
                <Link
                    to="/client/advisors?availability=today"
                    className="btn"
