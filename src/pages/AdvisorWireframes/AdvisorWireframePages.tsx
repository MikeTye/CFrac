...
const appt = normalizeAppointment(appointmentsData.appointments[0]);
const payment = normalizePayment(paymentsData.payments[0]);
const transcript = normalizeTranscript(transcriptsData.transcript);
