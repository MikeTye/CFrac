# AdvisorHistoricalRecordsPage — Implementation Prompt

## Objective
Build `AdvisorHistoricalRecordsPage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.
