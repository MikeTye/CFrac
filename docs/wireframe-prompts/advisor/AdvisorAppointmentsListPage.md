# AdvisorAppointmentsListPage — Implementation Prompt

## Objective
Build `AdvisorAppointmentsListPage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.
