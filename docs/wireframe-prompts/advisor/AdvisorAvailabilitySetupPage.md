# AdvisorAvailabilitySetupPage — Implementation Prompt

## Objective
Build `AdvisorAvailabilitySetupPage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.
