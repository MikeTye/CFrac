# AdvisorEmailVerificationPage — Implementation Prompt

## Objective
Build `AdvisorEmailVerificationPage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.
