# AdvisorOnboardingChecklistPage — Implementation Prompt

## Objective
Build `AdvisorOnboardingChecklistPage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.

## Inputs
- `/mocks/advisor/profile.json`
- `/mocks/advisor/notifications.json`
- `/mocks/advisor/availability.json`
