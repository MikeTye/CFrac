# AdvisorSessionSummaryPage — Implementation Prompt

## Objective
Build `AdvisorSessionSummaryPage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.
