# AdvisorPreSessionChecklistPage — Implementation Prompt

## Objective
Build `AdvisorPreSessionChecklistPage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.
