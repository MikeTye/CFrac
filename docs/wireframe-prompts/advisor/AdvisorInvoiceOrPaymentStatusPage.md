# AdvisorInvoiceOrPaymentStatusPage — Implementation Prompt

## Objective
Build `AdvisorInvoiceOrPaymentStatusPage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.
