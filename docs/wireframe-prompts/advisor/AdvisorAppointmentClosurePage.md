# AdvisorAppointmentClosurePage — Implementation Prompt

## Objective
Build `AdvisorAppointmentClosurePage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.
