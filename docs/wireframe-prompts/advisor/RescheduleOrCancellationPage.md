# RescheduleOrCancellationPage — Implementation Prompt

## Objective
Build `RescheduleOrCancellationPage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.

## Inputs
- `/mocks/advisor/appointments.json`
- `/mocks/advisor/disputes.json`
- `/mocks/scenarios/advisor-seed-scenarios.json`
