# AdvisorSessionNotesEditorPage — Implementation Prompt

## Objective
Build `AdvisorSessionNotesEditorPage` as an advisor-facing wireframe aligned to PRD booking and trust workflow.
